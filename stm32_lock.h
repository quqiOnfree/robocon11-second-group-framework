...
#elif defined(STM32_THREAD_SAFE_BAREMETAL_ALLOW_LOCKS) &&                      \
    (STM32_THREAD_SAFE_BAREMETAL_ALLOW_LOCKS != 0)
/*
...
#elif defined(STM32_THREAD_SAFE_BAREMETAL_DENY_LOCKS) &&                       \
    (STM32_THREAD_SAFE_BAREMETAL_DENY_LOCKS != 0)
/*
...
static inline void stm32_lock_release(LockingData_t *lock) {
  ...
  STM32_LOCK_BLOCK_IF_INTERRUPT_CONTEXT();
    ...
    (STM32_THREAD_SAFE_FREERTOS_ALLOW_LOCKS != 0)
/*
...
#endif /* defined (__GNUC__) && !defined (__CC_ARM) && !(defined               \
          (__ARMCC_VERSION) && (__ARMCC_VERSION >= 6010050)) &&                \
          configUSE_NEWLIB_REENTRANT == 0 */
...
#elif defined(STM32_THREAD_SAFE_FREERTOS_DENY_LOCKS) &&                        \
    (STM32_THREAD_SAFE_FREERTOS_DENY_LOCKS != 0)
/*
